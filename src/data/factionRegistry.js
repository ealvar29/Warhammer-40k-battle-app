...
export const FACTION_META = {
  spacewolves:      { name: 'Space Wolves',        icon: '🐺', color: '#c8d4e0', artPosition: 'center 30%',
  ...
  tyranids:         { name: 'Tyranids',            icon: '🦂', color: '#a855f7', artPosition: 'center 40%',
  ...
  chaosspacemarines:{ name: 'Chaos Space Marines', icon: '💀', color: '#b91c1c', artPosition: 'center 25%',
  ...
  darkangels:       { name: 'Dark Angels',         icon: '⚔️', color: '#22c55e', artPosition: 'center 20%',
  ...
  admech:           { name: 'Adeptus Mechanicus',  icon: '⚙️', color: '#d97706', artPosition: 'center 35%',
  ...
  spacemarines:     { name: 'Space Marines',       icon: '🛡️', color: '#3b82f6', artPosition: 'center 25%',
  ...
  deathguard:       { name: 'Death Guard',         icon: '☣️', color: '#4a7c3f', artPosition: 'center 15%',
  ...
  emperorschildren: { name: "Emperor's Children",  icon: '💜', color: '#9333ea', artPosition: 'center 30%',
  ...
  tau:              { name: "T'au Empire",         icon: '🔵', color: '#00b4d8', artPosition: 'center 35%',
  ...
  thousandsons:     { name: 'Thousand Sons',       icon: '🔮', color: '#3b82f6', artPosition: 'center 20%',
  ...
  worldeaters:      { name: 'World Eaters',        icon: '🩸', color: '#dc2626', artPosition: 'center 35%',
  ...
  aeldari:          { name: 'Aeldari',             icon: '🌙', color: '#8b5cf6', artPosition: 'center 25%',
  ...
  necrons:          { name: 'Necrons',             icon: '💚', color: '#10b981', artPosition: 'center 30%',
