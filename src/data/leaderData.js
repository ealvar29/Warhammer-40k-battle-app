...
export const leaderAbilities = {
    ...
    abilities: [
      {
        ...
        reminder: '[SUSTAINED HITS 1] on all weapons. Re-roll hit of 1 against units within 6".',
      },
      {
    ...
    abilities: [
      {
        ...
        reminder: 'Return 1 destroyed model to this unit each Command phase.',
      },
      {
        name: 'Litany of Hate',
        phase: 'fight',
        ...
        reminder: '+1 to Wound roll on all melee attacks.',
      },
    ],
  },

  wolfPriest_greyHunters: {
    leaderId: 'wolfPriest',
    unitId: 'greyHunters',
    abilities: [
      {
  ...
  wolfPriest_wolfGuardHeadtakers: {
    leaderId: 'wolfPriest',
    unitId: 'wolfGuardHeadtakers',
    abilities: [
      {
    ...
    abilities: [
      {
        ...
        reminder: 'Ranged weapons gain [ASSAULT]. When Advancing, add 6" to Move instead of rolling.',
      },
      {
        name: "Tempest's Wrath (Psychic)",
        phase: 'shooting',
        description: "In your Shooting phase, after this model's unit has shot, select one enemy unit (excluding MONSTERS and VEHICLES) hit by one or more of those attacks made with this model's Living Lightning weapon. Until the start of your next turn, that enemy unit is stormwracked — subtract 6\" from the Range characteristic of ranged weapons equipped by models in that unit (to a minimum of 12\").",
        reminder: "After shooting with Living Lightning, target hit enemy loses 6\" from all ranged weapon ranges until your next turn.",
      },
    ],
  },
    ...
    abilities: [
      {
        ...
        reminder: 'When a Terminator is killed in melee, roll D6 — on 4+ it fights back before being removed.',
      },
      {
        name: 'Champion of the Kingsguard',
        phase: 'fight',
        description: 'Each time Arjac makes a melee attack that targets a CHARACTER unit, you can re-roll the Hit roll and you can re-roll the Wound roll.',
        reminder: 'Arjac re-rolls hits AND wounds against enemy CHARACTERS.',
      },
      {
        name: 'Deep Strike',
        phase: 'movement',
        description: 'The whole unit can be set up in Reserves during Declare Battle Formations. At the start of one of your Movement phases, set it up anywhere on the battlefield more than 9" from all enemy models.',
        reminder: '⚡ This unit can Deep Strike — drop in 9"+ from enemies instead of deploying normally.',
      },
    ],
  },
    ...
    abilities: [
      {
        name: "Slayer's Oath",
        phase: 'any',
        description: "At the start of the battle, select one keyword: CHARACTER, MONSTER, or VEHICLE. Each time this model's unit destroys a unit with that keyword, for the rest of the battle, this model's unit gains the benefits as if it had completed a Saga detachment rule.",
        reminder: "Choose a target type at battle start. Destroying that type grants Saga detachment benefits.",
      },
      {
        name: 'Oathbound',
        phase: 'fight',
        description: "While this model is leading a unit, each time a model in that unit makes a melee attack, add 1 to the Hit roll. Each time a model in that unit makes a melee attack that targets a unit with the keyword chosen for Slayer's Oath, also add 1 to the Wound roll.",
        reminder: "+1 to Hit on all melee attacks. +1 to Wound vs your Slayer's Oath target.",
      },
    ],
  },
...
export const unitLeaderMap = {
  // Space Wolves
  bloodClaws: ['ragnar', 'njal', 'ulrik', 'wolfGuardBattleLeader', 'wolfPriest', 'ironPriest', 'wolfGuardPackLeader'],
  greyHunters: ['njal', 'ulrik', 'wolfGuardBattleLeader', 'wolfPriest', 'ironPriest', 'wolfGuardPackLeader', 'runePriest'],
  wolfGuard: ['wolfGuardPackLeader', 'loganGrimnar', 'runePriest', 'wolfGuardBattleLeader', 'wolfPriest'],
  wolfGuardHeadtakers: ['ragnar', 'njal', 'ulrik', 'wolfGuardBattleLeader', 'wolfPriest', 'ironPriest'],
  wolfGuardTerminators: ['loganGrimnar', 'arjacRockfist'],
  thunderwolfCavalry: [],
  wulfen: [],
  // Tyranids
