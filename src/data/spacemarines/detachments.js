...
export const smDetachments = {
  ...
  gladiusStrikeForce: {
    ...
    commandPhaseAction: {
      type: 'pick_one',
      perRound: false,
      confirmLabel: 'Activate this Doctrine →',
      label: 'Combat Doctrine',
      prompt: 'Select one Combat Doctrine (each can only be chosen once per battle):',
      options: [
        {
          id: 'devastatorDoctrine',
          label: 'Devastator',
          icon: '🎯',
          shortEffect: '[HEAVY] on all ranged weapons',
          fullEffect: 'ADEPTUS ASTARTES CORE and CHARACTER units: ranged weapons gain the [HEAVY] ability. +1 to Hit rolls if the bearer did not move this turn.',
          unitEffects: {
            phases: ['shooting'],
            factionKeywords: ['ADEPTUS ASTARTES'],
            badge: 'Devastator: +1 Hit (Heavy)',
            badgeColor: '#60a5fa',
            why: "Devastator Doctrine — ranged weapons have [HEAVY]: +1 to Hit if the unit didn't move this turn",
          },
        },
        {
          id: 'tacticalDoctrine',
          label: 'Tactical',
          icon: '⚔️',
          shortEffect: 'Re-roll 1 Hit per attack',
          fullEffect: 'ADEPTUS ASTARTES CORE and CHARACTER units: each time a model makes an attack (ranged or melee), you can re-roll one Hit roll.',
          unitEffects: {
            phases: ['shooting', 'fight'],
            factionKeywords: ['ADEPTUS ASTARTES'],
            badge: 'Tactical: Re-roll 1 Hit',
            badgeColor: '#c9a84c',
            why: 'Tactical Doctrine — re-roll one Hit roll per attack in both Shooting and Fight phases',
          },
        },
        {
          id: 'assaultDoctrine',
          label: 'Assault',
          icon: '🗡️',
          shortEffect: 'Melee weapons gain [LANCE]',
          fullEffect: 'ADEPTUS ASTARTES CORE and CHARACTER units: melee weapons gain the [LANCE] ability. +1 to Wound rolls if the unit made a Charge move this turn.',
          unitEffects: {
            phases: ['charge', 'fight'],
            factionKeywords: ['ADEPTUS ASTARTES'],
            badge: 'Assault: Lance (melee)',
            badgeColor: '#f87171',
            why: "Assault Doctrine — melee weapons have [LANCE]: +1 to Wound rolls if unit charged this turn",
          },
        },
      ],
    },
